...
def abbrev_path(path = None):
    ...
    if os.path.normcase(path).startswith(os.path.normcase(os.path.expanduser('~'))):
    ...
    return path_abbrev if path_abbrev == '~' and not path else path_abbrev + os.sep + path.split(os.sep)[-1]
